...
/**
 * 获取字符串的首字母
 * CopyRight @2016 Casia.Ibasic All Rights Reserved.
 * @author Junfeng.Li
...
public class Pinyin2Abbreviation {
	 ...
	 * <p>2016年5月18日 上午9:31:47</p>
	 */
	public static Character getFirstCharacter(String str, Character fault){
		if(null == str || str.isEmpty()) return fault;
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			System.out.println("[" + getFirstCharacter(str, '#') + "]:\t" + str);
		}
	}
}